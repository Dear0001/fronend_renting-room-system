...
function Verify() {
    ...
    const [countdown, setCountdown] = useState(60); // Initialize countdown state to 60 seconds
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.message === 'OTP is verified') {
            ...
            router.push(`/newPassword?email=${encodeURIComponent(email)}&otp=${encodeURIComponent(otpValue)}`);
        } else {
                                    ...
                                    <div className="-z-0 relative w-full h-full flex justify-center items-center">
                                        <div className="right-[-40px] top-[80px] w-[407px] h-[512px] flex items-center justify-center">
                                            <div className=''>
                                                ...
                                                <p className="text-paragraph16_regular text-[#858080] mt-[2px] w-full">An email verify code has been send to your email.</p>

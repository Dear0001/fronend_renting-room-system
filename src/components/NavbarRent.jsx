                        ...
                        <div className="relative">
                            ...
                            {isOpen && (
                                <div
                                    ...
                                    className="absolute z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-blue-700 dark:divide-gray-600"
                                >
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                        <li>
                                            <a href="#"
                                               className="block px-4 py-2 hover:bg-blue-400 dark:hover:bg-blue-600 dark:hover:text-white">
                                                Settings
                                            </a>
                                        </li>
                                    </ul>
                                    <div className="py-2">
                                            <Link href={"/register"} className="self-stretch my-auto cursor-pointe block px-4 py-2 text-sm text-gray-700 hover:bg-blue-400 dark:hover:bg-blue-600 dark:text-gray-200 dark:hover:text-whiter"
                                                  onClick={handleClick}>

...
const OwnerDownload = () => {
    return (
        <div className="flex flex-col gap-5 max-md:flex-wrap">
            <div
                className="flex flex-col gap-2.5 self-center px-5 -mt-24 text-black max-md:flex-wrap max-md:max-w-full">
                <div className="gap-0 text-4xl font-bold max-md:flex-wrap max-md:max-w-full">
                    Sopheak Saing
                </div>
            ...
            <div className="flex gap-5 mt-5 w-full max-md:flex-wrap max-md:max-w-full">
                <div
                    className="flex overflow-x-auto flex-col grow shrink-0 gap-0 justify-center basis-0 w-fit max-md:flex-wrap max-md:max-w-full">
                    <div
                ...
                <Image width={10} height={10}
                    ...
                    className="grow shrink-0 h-[560px] gap-0 aspect-[1.54] basis-0 w-fit max-md:flex-wrap max-md:max-w-full"
                 alt={"d"}/>
            </div>
            <div className={"flex"}>
                <div
